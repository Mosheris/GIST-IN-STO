# ==============================================================================
# 小肠 RSF 模型 SHAP 决策图 (极速提速 + 临床数值还原版)
# ==============================================================================
import pandas as pd
import numpy as np
...
print("=" * 80)
print("🏥 小肠 RSF 模型 SHAP 决策图 (Decision Plot)")
print("=" * 80)
...
output_dir = f"SHAP_小肠_decision_{timestamp}"
...
try:
    ...
    # 只在需要时加载训练集用作背景
    train_df = pd.read_excel('Intestine_final.xlsx', sheet_name='Train')
