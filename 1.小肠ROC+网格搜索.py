...
# ==============================================================================
print("📂 正在双轨加载小肠队列数据...")
train_raw_df = pd.read_excel('Intestine_AllFeatures_Raw.xlsx', sheet_name=0)
test_raw_df = pd.read_excel('Intestine_AllFeatures_Raw.xlsx', sheet_name=1)

train_scaled_df = pd.read_excel('Intestine_AllFeatures_Scaled.xlsx', sheet_name=0)
test_scaled_df = pd.read_excel('Intestine_AllFeatures_Scaled.xlsx', sheet_name=1)
...
print("\n🏆 终极 5 大金刚 t-AUC 效能评估成绩单 (基于小肠测试集)：")
print("-" * 75)
