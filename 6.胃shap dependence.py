# ==============================================================================
# 胃 RSF 模型 SHAP 依赖散点图 (智能 Cutoff 计算 + 临床数值还原版)
# ==============================================================================
import pandas as pd
import numpy as np
...
print("=" * 80)
print("🏥 胃 RSF 模型 SHAP 依赖散点图 (Dependence Scatter Plot)")
print("=" * 80)
...
output_dir = f"SHAP_胃_scatter_{timestamp}"
...
print("=" * 80)
print("🚀 胃 SHAP 依赖散点图 (Scatter Plot) 分析完美收官！")
print("=" * 80)
