...
print("=" * 80)
print("🏥 小肠 RSF 模型 SHAP 决策图 + 散点图分析 (Combined Version)")
print("=" * 80)
...
output_dir = f"SHAP_小肠_combined_{timestamp}"
